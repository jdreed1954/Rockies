...
header-includes:
  ...
  \pagestyle{fancy}
  \fancyhead[CO,CE]{}
  \fancyfoot[CO,CE]{Colorado Rockies Newsletter 2017, Week \#23}
...
```
```{r Headline,fig.cap = "Rockies activate Tyler Anderson from te disabled list."}
knitr::include_graphics("images/Tyler_Anderson.jpg")
```
...
Well the Rockies are still in the hunt for a playoff Wild Card berth.  The Blake Street gang have turned on the the wins this week winning five of six games.  The Dodgers are in the middle of a stutter-step,losing ten in a row.  Hard to believe, I know.  

 A lot can happen in the nineteen remaining games.  Hang onto your hats, this is what makes baseball so much garsh darn fun this time of year.
 
Keep thinking positive thoughts.


* **Featured Article**  
    + None this week.  Returning next week, maybe.
