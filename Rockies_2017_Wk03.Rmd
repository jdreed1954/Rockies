...
Colorado ranked 19th out of 30 with a total payroll of $121M in 2016.  Compare this with the Rockies' ranking in season attendance of 11 (2.602M attendance in 2016).  Perhaps there is revenue that can be leveraged to the player roster?
...
knitr::kable(s, format = "markdown", format.args = list(big.mark = ","), 
             digits = 1, caption = "2016 MLB Total Payroll in Millions of Dollars")
```
\newpage

# MLB Payrolls for 2016 Bar Chart
...
ggplot(SalG, aes(x = reorder(Tm, Payroll), y = Payroll, fill = LgDiv)) + 
  ...
  scale_fill_brewer(palette = "Set2", direction = 1) + 
  xlab("Team") + 
  ylab("MLB Payroll for 2016") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  scale_y_continuous("MLB Payroll 2016", ) +
