...
header-includes:
  ...
  \pagestyle{fancy}
  \fancyhead[CO,CE]{}
  \fancyfoot[CO,CE]{Colorado Rockies Newsletter 2017, Week \#21}
...
```
```{r Headline,fig.cap = "Tony Wolters and Jake McGee celebrate after the Rockies defeated the Braves, 3-0. (John Amis/AP)"}
knitr::include_graphics("images/Wolters-McGee-2.jpg")
```
...
We are right around the corner from Fall weather and the World Series.  The Rockies almost certainly will qualify for the playoffs as a wildcard entry in the NL ladder.

The featured article concerns the playoff odds for all six of the MLB divisions.  Each team's odds of making it to each successive round and ultimately to the World Series are presented.  Many teams are statistically out of the running for even a wildcard berth, hence their odds of any post-season appearance is zero.  

As the rest of the season progresses, these tables will change.  It may be an idea to keep an eye on the odds.  As many in the know tell coeds entering Colorado School of Mines, "The odds are good, but the goods are odd."
