...
header-includes:
  ...
  \pagestyle{fancy}
  \fancyhead[CO,CE]{}
  \fancyfoot[CO,CE]{Colorado Rockies Newsletter 2017, Week \#25}
...
```
```{r Headline,fig.cap = "Ted Williams and Babe Ruth shake hands."}
knitr::include_graphics("images/Ted_and_Babe-1.jpg")
```
...
Our Colorado Rockies won two of six this past week and currently set at 84 and 72.  They are two games ahead of the Brewers in the wild card race.

The Colorado Rockies are closing in on the end of the regular season with only six more games.  There is more than six-bits chance (76.8 percent) that the Rox will get on board the playoff train.  

Hang onto your rally caps, mile-high fans.  Anything can happen.
