...
header-includes: \usepackage{fancyhdr} \pagestyle{fancy} \fancyhead[CO,CE]{} \fancyfoot[CO,CE]{Colorado
  Rockies Newsletter 2018, Week \#1} \fancyfoot[LE,RO]{\thepage}
---
...
```
```{r Headline,fig.cap = "Charlie Blackmon signed a six-year extension with the Rockies.  Total value of the cntract is $108M and could reach as high as $116M if certain incentives are met."}
knitr::include_graphics("images/charlie-blackmon-5.jpg")
```
